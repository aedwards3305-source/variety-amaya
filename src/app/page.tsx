...
export default function Home() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await fetch("https://formspree.io/ospreysolutionllc@gmail.com", {
        method: "POST",
        headers: {
      ...
      <footer className="bg-gray-900 text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-3 gap-12">
            ...
            <div>
              <div className="mb-6">
                <div className="relative w-28 h-28 drop-shadow-[0_0_15px_rgba(212,175,55,0.5)]">
                  <Image
                    src="/logo.png"
                    alt="Variety Amaya LLC"
                    fill
            ...
            <div>
              ...
              <div className="space-y-4 text-gray-400">
                ...
                <p className="flex items-center gap-3">
                  ...
                  <a href="https://varietyamaya.com" className="hover:text-gold transition-colors">
                    varietyamaya.com
                  </a>
                </p>
              </div>
